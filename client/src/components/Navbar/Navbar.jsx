...
const Navbar = () => {
  ...
  return (
    <nav className="bg-[#2D1B0E] border-b-8 border-amber-900/30 sticky top-0 z-50 shadow-[0_25px_50px_-12px] font-vibe group/nav overflow-x-hidden">
      <div className="absolute -top-3 left-1/2 -translate-x-1/2 w-full max-w-7xl px-4">
        ...
        <div>
          <GiForkKnifeSpoon
            className="text-amber-500/40 -ml-2 rotate-45"
            size={32}
          />
          <GiForkKnifeSpoon
            className="text-amber-500/40 -mr-2 rotate-45"
            size={32}
          />
        </div>
      </div>
        ...
        <div className="flex justify-between items-center h-16 md:h-20 lg:h-24">
          ...
          <div className="flex-shrink-0 flex items-center space-x-2 group relative md:-translate-x-4 lg:-translate-x-6 ml-0 md:ml-2">
            ...
            <div className="flex flex-col relative ml-2 max-w-[140px] md:max-w-[160px] lg:max-w-none">
              <NavLink
                to="/"
                className="text-2xl md:text-xl lg:text-4xl bg-gradient-to-r from-amber-400 to-amber-600 bg-clip-text text-transparent font-monsieur tracking-wider drop-shadow-[0_2px_2px] drop-shadow-black -translate-x-2 truncate"
              >
                Foodie-Frenzy
              </NavLink>
